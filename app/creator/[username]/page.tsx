...
export default function CreatorProfilePage() {
  ...
  const [allPosts, setAllPosts] = useState<FirebasePost[]>([]) // Store all posts
  const [displayedPosts, setDisplayedPosts] = useState<FirebasePost[]>([]) // Posts currently displayed
            ...
            {currentUserProfile?.username !== creator.username && (
              ...
              >
                <Button
                  size="sm"
                  variant="outline"
                  className="rounded-full bg-transparent hover:bg-primary/10 border-primary/50 text-primary text-xs sm:text-sm"
