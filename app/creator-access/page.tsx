...
export default function CreatorAccessPage() {
  ...
  useEffect(() => {
    console.log("[v0] Creator Access Page mounted - redirectTo:", redirectTo)
    return () => console.log("[v0] Creator Access Page unmounted")
  }, [redirectTo])
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("[v0] Form submitted with code:", accessCode)
    ...
    console.log("[v0] Code validated successfully, redirecting to:", redirectTo)

    if (redirectTo === "login") {
      console.log("[v0] Redirecting to /creator-login")
      window.location.href = "/creator-login"
    } else {
      console.log("[v0] Redirecting to /creator-signup")
