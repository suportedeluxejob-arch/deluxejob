...
export function StoryCreatorModal({ isOpen, onClose, userId, username, onSuccess }: StoryCreatorModalProps) {
      ...
      if (storyType === "temporary") {
        for (const media of validMedia) {
          await createTemporaryStory(
            ...
            storyDuration,
            "", // caption
            media.type === "video" ? media.url : undefined, // videoUrl
          )
        }
      } else {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[9999] p-3 sm:p-4">
      <Card className="w-full max-w-md max-h-[85vh] sm:max-h-[90vh] overflow-y-auto shadow-2xl">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] sm:text-xs text-muted-foreground mt-1">
                      Aparece com círculo colorido no seu perfil. Expira automaticamente após o período escolhido.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-2.5 sm:p-3 rounded-lg bg-primary/10 border border-primary/20">
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] sm:text-xs text-muted-foreground mt-1">
                      Fica salvo no seu perfil permanentemente. Ideal para conteúdo importante.
                    </p>
                  </div>
                </div>
              </div>
