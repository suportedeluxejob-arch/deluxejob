  ...
  if (children) {
    return (
      <>
        ...
        >
          {children}
          <div className="absolute bottom-0 right-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center shadow-lg ring-3 ring-background group-hover:scale-110 transition-transform duration-200">
